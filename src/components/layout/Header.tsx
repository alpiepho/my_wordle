...
export default function Header({ mode, onModeChange, onHelp, onStats, onSettings }: HeaderProps) {
  return (
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex gap-1 mt-1">
          <button
            ...
            className={`px-3 py-0.5 text-xs font-medium rounded-full transition-colors cursor-pointer ${
              mode === 'daily'
